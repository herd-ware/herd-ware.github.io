var relearn_search_index = [
  ...
  {
    "content": "  Name origin Image's source.  Aubrac is a french breed of cows from the Plateau de l’Aubrac in the south-central of France. It is mainly raised for its meat, but also for its milk which can be used for the Laguiole cheese.\n  This page and the following ones describe the Aubrac core. It is single issue in-order CPU build around a classic pipeline and two levels of cache memories. Based on the RISC-V ISA, it is developed in Chisel3 and has a lot of different parameters (the data size, the number of stages, the supported extensions etc).\nOverview   \nFigure 1: Overview of the the Aubrac core.  All the possible stages are represented, even if some of them are optional.    The Figure 1 represents the whole Aubrac core. It is composed of 8 parts. The Front-End is responsible of the instruction fetch. The NLP is used to predict control-flow changes. The Back-End is responsible of the decoding and the execution of the instructions. The Dome Management Unit (DMU) is an execution unit dedicated to dome management (CEPS ISA). The I/O module is used for core’s specific memory addressable mechanism (e.g. privileged timers). L1I, L1D and L2 are respectively the Level 1 Instruction, Level 1 Data and the Level 2 (Instruction and Data) private cache memories.\nISA support The Aubrac core is based on the RISC-V ISA. It currently supports both 32 and 64 bits bases.\n   Extension Version Implemented ? Tested ? Optional ? Depends on …     M 2.0       A 2.1       B 1.0.0       Zicsr        Zicntr        Zifencei 2.0        Table 1: Summary of the different supported RISC-V extensions by the Aubrac core.  Some still have to be tested more in depth.    As described on the Table 1, multiple extensions are currently implemented in the Aubrac. Most of them are optional: the dedicated hardware parts are completely removed during Verilog generation.\n Warning If both 32 and 64 bits are implemented, only 32 bits version is currently used and tested. More work is needed to verify 64 bit specific instructions, like ones dedicated to word-size datas.\n  Table of contents Front-end  Next-line predictor (NLP)  Back-end ID stage EX{0-2} stage MEM stage WB stage GPR CSR Memory hierarchy Core Local Interrupt (CLINT) Restricted timers Hardware Performances Monitor (HPM) Top Pipeline Core Parameters  ",
    "description": "",
    "tags": null,
    "title": "Aubrac core",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Cache memory",
    "uri": "/doc/hw/mem/hay/cache/index.html"
  },
  {
  ...
  {
    "content": "Overview   \nFigure 1: Overview of the the Aubrac pipeline.  All the possible stages are represented, even if some of them are optional.    ",
    "description": "",
    "tags": null,
    "title": "Pipeline",
  ...
  {
    "content": "  \nFigure 1: Overview of the the Aubrac core.  All the possible stages are represented, even if some of them are optional.    ",
    "description": "",
    "tags": null,
    "title": "Core",
  ...
  {
    "content": "Table of contents Abondance core  Aubrac core Front-end Next-line predictor (NLP) Back-end Memory hierarchy Top Salers core   Summary    Core Abbreviation Version     Aubrac AU 0.0.1   Abondance AB 0.0.1   Salers SA     ",
    "description": "",
    "tags": null,
    "title": "Cores",
  ...
  {
    "content": "Execution Units Arithmetic and Logic Unit (ALU) Branch Unit (BRU) Multiplication and Division Unit (MULDIV) ",
    "description": "",
    "tags": null,
    "title": "EX{0-2} stage",
  ...
  {
    "content": " Common Memory Bus for Security (MB4S) Cores Abondance core Aubrac core Salers core I/Os GPIO UART SPI I2C PS/2 Timers Memories Hay cache memory Platforms Cheese platform  ",
    "description": "",
    "tags": null,
    "title": "Hardware",
  ...
  {
    "content": "  Category Name Address   BOOT Start 0x00000000  End 0x03ffffff  ROM Start 0x04000000  End 0x07ffffff  RAM Start 0x08000000  End 0x0cffffff  Core I/Os Start 0x10000000  End 0x17ffffff  Platform I/Os Start 0x18000000  End 0x1fffffff   ",
    "description": "",
    "tags": null,
  ...
  {
    "content": "Overview  Figure 1: Overview of the NLP.  Each cycle, the Front-End requests the NLP to have informations about the next PC. If it corresponds to a known taken branch or jump, the NLP specute on the following PC.    Internal components Branch Target buffer (BTB)  Figure 1: Description of the BTB's working.  When a jump or branch is detected, its informations are stored in the BTB. Later, before fetching the PC, the BTB is read to anticipate potential control flow change using available informations.    Branch History Table (BHT)  Figure 2: Principle of the BHT's finite state machine.  Each new branch updates the counter which indicates if the last ones were mainly taken or not-taken.     Figure 3: Description of the BHT's working.  The LSBs of the address of each branch lead to a particular counter. Depending on its MSB value, the BHT can indicate if a branch must be taken* or not-taken.    Return Stack Buffer (RSB)  Figure 4: Description of the BHT's working.  When a call is detected, the PC of the following instruction (basically PC + 4) is stored on top of the RSB, and the pointer is encremented. When a return is detected, the last value on the RSB is returned, and the pointer is decremented.    ",
    "description": "",
    "tags": null,
    "title": "Next-line predictor (NLP)",
    "uri": "/doc/hw/cores/aubrac/nlp/index.html"
  },
  {
    "content": "",
    "description": "",
    ...
    "uri": "/doc/hw/mem/hay/prev/index.html"
  },
  {
    "content": "",
    "description": "",
  ...
  {
    "content": "   Name Description     cycle Cycles since the last global reset.   time Cycles since the last global reset.   instret Retired instrictions    ",
    "description": "",
    "tags": null,
  ...
  },
  {
    ...
    "uri": "/doc/hw/mem/hay/next/index.html"
  },
  {
    "content": "Description    Name Type Values Description     debug Boolean true / false Enable / disable the generation of signals and registers for debug during simulation.   pcBoot String “hhhhhhhh” Address of the first executed instruction.   nAddrBit Int 32 Address size.   nDataBit Int 32 / 64 Data size.   nFetchInstr Int 2^N Number of instructions simultaneously fetched.   useIMemSeq Boolean true / false Enable / disable sequential access to the instruction memory (e.g. flush is considered only in the next cycle).   useIf1Stage Boolean true / false Enable / disable the IF1 stage.   nFetchBufferDepth Int N Size of the fetch buffer.    Table 1: Summary of the different global parameters of the Aubrac core.     Chisel example ",
    "description": "",
    "tags": null,
    "title": "Parameters",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Prefetcher",
    "uri": "/doc/hw/mem/hay/pftch/index.html"
  },
  {
    "content": "",
    "description": "",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Top",
    "uri": "/doc/hw/mem/hay/top/index.html"
  },
  {
    "content": "",
    "description": "",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Timers",
    "uri": "/doc/hw/io/timers/index.html"
  },
  {
  ...
  {
    "content": "  Warning This site is a Work in Progress. More content coming soon.\n  ",
    "description": "",
    "tags": null,
    "title": "HerdWare",
    "uri": "/index.html"
