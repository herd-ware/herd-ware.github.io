var relearn_search_index = [
  ...
  {
    "content": "Récapitulatif    Name Description     alu Instructions de type ALU exécutées.   bru Instructions de type BRU exécutées.   cycle Cycles depuis le dernier reset global.   instret Instructions exécutées.   l1ihit Accès au L1I étant un hit.   l1ipftch Accès au L1I anticipé par le prefetcher.   l1imiss Accès au L1I étant un misse.   l1dhit Accès au L1D étant un hit.   l1dpftch Accès au L1D anticipé par le prefetcher.   l1dmiss Accès au L1D étant un misse.   l2hit Accès au L2 étant un hit.   l2pftch Accès au L2 anticipé par le prefetcher.   l2miss Accès au L2 étant un misse.   ld Instructions load exécutées.   mispred Instructions de type BRU exécutées mais mal prédites.   rdcycle Instructions rdcycle exécutées.   st Instructions store exécutées.   time Cycles depuis le dernier reset global.    Tableau 1: Description des différents compteurs de performance.     ",
    "description": "",
    "tags": null,
  ...
  {
    "content": "  Remarque Tous les tags des versions du projet disponibles sur GitHub ont le suffixe *-public. Cela permet de les distinguées des versions propres aux travaux de recherche en cours et pas encore publiés.\n  v0.0.1 - 2023-03-30  Documentation publique sur GitHub. Mise à disposition des codes sur GitHub:  Common (v0.0.1), Aubrac (v0.0.1), Abondance (v0.0.1), Hay (v0.0.1), I/Os (v0.0.1), Cheese (v0.0.1), répertoire root (v0.0.1), isa-tests (v0.0.1).    ",
    "description": "",
    "tags": null,
    "title": "Historique",
